...
<?php include("../style/menu.php")?>
			...
			<div id="content2">
					<div class="box">
                        <h2><center>March Madness</center></h2> <br><br>
                        ...
                        <img class="aligntop" src="images/Monday.png" width="900" height="600" alt="" />
                        <a href="images/Monday.png" rel="lightbox[brackets]" title="Current Best">Final Bracket</a>
                        <a href="images/early.png" rel="lightbox[brackets]" title="10 Minutes In">Early</a>
                        <a href="images/one_day.png" rel="lightbox[brackets]" title="One Day Later">One Day Later</a>
                        <a href="images/close.png" rel="lightbox[brackets]" title="Almost There">Almost There</a>
                        <a href="images/final.png" rel="lightbox[brackets]" title="Sunday Night">Sunday Night</a>

                        </p>
                        <br><br>
                        <h3><center>Data Abstraction</center></h3>
                        ...
                        could be :).
                        <br><br>
                        <h3><center>Possible Improvements</center></h3>
                        My model of a team is frankly not very good.  It does not incorporate individual player matchups, injuries or how the team has done recently.
                        ...
                        <br><br>
                        <h3><center>A Note On Using My Code</center></h3>
                        Due to legal restrictions I am not allowed to broadcost kenpom's data to a general audience.
                        ...
                        If you e-mail me I will send you the one time pad file, and then you can get the orginal DB in the right place with the following function.
                        <br><br>
                        <center>python 2013/scripts/helpers/one_time_pad.py 2013/data/encrypt.db path/to/padfile</center>
                        <br><br>
                        With that database you can run all my analysis found in 2013/scripts/analyze.py
                        <br><br>
                        <center>cd 2013/scripts</center>
                        <center>python analyze.py</center>
                        <br><br>
					<div class="box">
					</div>
